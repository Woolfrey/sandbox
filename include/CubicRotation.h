/*
*	A minimum acceleration trajectory across two or more orientations in 3D space.
*/
...
/******************** Constructor ********************/
CubicRotation::CubicRotation(const std::vector<iDynTree::Rotation> &rots, const std::vector<double> &times)
				: Cubic()						// Base object		
				, R(rots)
{
